...
<%--    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css">--%>
    <!-- Bootstrap core CSS -->
    <link href="http://127.0.0.1:3003/boot/static/css/bootstrap.min.css" rel="stylesheet">
    <!-- Material Design Bootstrap -->
    <link href="http://127.0.0.1:3003/boot/static/css/mdb.min.css" rel="stylesheet">
    <!-- Your custom styles (optional) -->
    <link href="http://127.0.0.1:3003/boot/static/css/style.min.css" rel="stylesheet">

    <meta name="baidu-tc-cerfication" content="52031c379393b942ce0d59195791f366" />
    <link href="http://127.0.0.1:3003/boot/static/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
...
<!-- SCRIPTS -->
<!-- JQuery -->
        <script src="http://127.0.0.1:3003/boot/static/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
        <script src="http://127.0.0.1:3003/boot/static/Cron/jquery.easyui.min.js" type="text/javascript"></script>
        <script src="http://127.0.0.1:3003/boot/static/Cron/cron.js" type="text/javascript"></script>
