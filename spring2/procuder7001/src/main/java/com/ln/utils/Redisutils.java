...
public  class Redisutils implements Cache {
  ...
  // private static final JedisConnectionFactory factory = new JedisConnectionFactory();
    ...
    @Autowired
    private RedisTemplate<String,Object> functionDomainRedisTemplate;
    ...
    public RedisTemplate<String, Object> getFunctionDomainRedisTemplate() {
        return functionDomainRedisTemplate;
    }

    public void setFunctionDomainRedisTemplate(RedisTemplate<String, Object> functionDomainRedisTemplate) {
        this.functionDomainRedisTemplate = functionDomainRedisTemplate;
    }
    ...
    public void setMap(String key,Map<String,Object> map) {
        ...
        functionDomainRedisTemplate.execute(new RedisCallback<Boolean>() {
    ...
    public Map<String,Object> getMap(String key){
        ...
        Map<String, Object> map =	functionDomainRedisTemplate.execute(new RedisCallback<Map<String,Object>>() {
            ...
            public Map<String, Object> doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                //ObjMap = (Map<Object, Object>) toObject(byteMap.toString().getBytes());
                return ObjMap;
            }
    ...
    public void Pipeline(Map<String,Object> map) {
        ...
        functionDomainRedisTemplate.execute(new RedisCallback<Long>() {
    ...
    public ValueWrapper get(Object key) {
        // TODO Auto-generated method stub
        Object obj = functionDomainRedisTemplate.execute(new RedisCallback<Object>() {
    ...
    public List<Object> getList(String key){
        byte[] keys = key.toString().getBytes();
        List<Object> objall = functionDomainRedisTemplate.execute(new RedisCallback<List<Object>>() {
